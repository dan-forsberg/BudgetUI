...
var app = (function () {
    ...
    const file$9 = "src/components/read/ViewCategory.svelte";
    ...
    function create_else_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$9, 26, 1, 594);
    			add_location(p1, file$9, 27, 1, 611);
    		},
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
			...
			: "+" + /*total*/ ctx[3]}`;
    			...
    			add_location(h3, file$9, 8, 1, 211);
    			add_location(th0, file$9, 11, 3, 273);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file$9, 12, 3, 297);
    			attr_dev(tr0, "class", "svelte-13a5tvb");
    			add_location(tr0, file$9, 10, 2, 265);
    			add_location(td0, file$9, 21, 3, 491);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$9, 22, 3, 510);
    			attr_dev(tr1, "class", "svelte-13a5tvb");
    			add_location(tr1, file$9, 20, 2, 483);
    			attr_dev(table, "class", "svelte-13a5tvb");
    			add_location(table, file$9, 9, 1, 255);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			td1 = element$1("td");
    			t2 = text$1(t2_value);
    			add_location(td0, file$9, 16, 4, 391);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$9, 17, 4, 424);
    			attr_dev(tr, "class", "svelte-13a5tvb");
    			add_location(tr, file$9, 15, 3, 382);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    ...
    const file$8 = "src/components/edit/InPlaceEdit.svelte";
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$8, 42, 1, 561);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$8, 40, 1, 493);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$7 = "src/components/edit/EditCategory.svelte";
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text$1("category = ");
    			t3 = text$1(/*category*/ ctx[1]);
    			add_location(p0, file$7, 71, 1, 1678);
    			add_location(p1, file$7, 72, 1, 1695);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
			...
			: "+" + /*total*/ ctx[3]}`;
    			...
    			attr_dev(h3, "class", "entries-header");
    			add_location(h3, file$7, 48, 1, 1096);
    			add_location(th0, file$7, 51, 3, 1158);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file$7, 52, 3, 1182);
    			attr_dev(tr0, "class", "svelte-13a5tvb");
    			add_location(tr0, file$7, 50, 2, 1150);
    			add_location(td0, file$7, 65, 3, 1519);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$7, 66, 3, 1538);
    			attr_dev(tr1, "class", "svelte-13a5tvb");
    			add_location(tr1, file$7, 64, 2, 1511);
    			attr_dev(table, "class", "svelte-13a5tvb");
    			add_location(table, file$7, 49, 1, 1140);
    			add_location(button, file$7, 69, 1, 1616);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    ...
    function create_each_block$3(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(tr, "class", "svelte-13a5tvb");
    			add_location(tr, file$7, 55, 3, 1267);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    const file$6 = "src/components/Budget.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 27, 1, 888);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$5 = "src/components/SelectBudget.svelte";
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 15, 14, 392);
    			add_location(h2, file$5, 15, 3, 381);
    			attr_dev(div, "class", "budget");
    			add_location(div, file$5, 14, 2, 357);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_pending_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 12, 2, 318);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 10, 0, 272);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/components/create/NewCategory.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			input1 = element$1("input");
    			add_location(h4, file$4, 88, 0, 2105);
    			input0.disabled = true;
    			attr_dev(input0, "type", "text");
    			input0.value = "Totalt";
    			attr_dev(input0, "class", "description svelte-1wif1oa");
    			add_location(input0, file$4, 101, 2, 2496);
    			input1.disabled = true;
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "amount svelte-1wif1oa");
    			add_location(input1, file$4, 102, 2, 2564);
    			attr_dev(div, "class", "entry-container svelte-1wif1oa");
    			add_location(div, file$4, 100, 1, 2464);
    			add_location(form, file$4, 89, 0, 2125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/components/create/NewBudget.svelte";
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 60, 2, 1589);
    			attr_dev(label, "for", "date");
    			add_location(label, file$3, 69, 3, 1809);
    			attr_dev(input, "id", "date");
    			attr_dev(input, "class", "input-date svelte-mz7exr");
    			attr_dev(input, "type", "text");
    			add_location(input, file$3, 70, 3, 1868);
    			add_location(br, file$3, 71, 3, 1946);
    			attr_dev(button, "class", "btn waves-effect waves-light indigo");
    			add_location(button, file$3, 72, 3, 1956);
    			attr_dev(div1, "class", "center");
    			add_location(div1, file$3, 68, 2, 1785);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 58, 2, 1544);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 62, 4, 1663);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 56, 0, 1486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$2, 7, 7, 191);
    			add_location(li0, file$2, 7, 3, 187);
    			attr_dev(a1, "href", "/new");
    			attr_dev(a1, "class", "svelte-1hkku9o");
    			add_location(a1, file$2, 8, 7, 223);
    			add_location(li1, file$2, 8, 3, 219);
    			attr_dev(a2, "href", "/edit");
    			attr_dev(a2, "class", "svelte-1hkku9o");
    			add_location(a2, file$2, 9, 7, 264);
    			add_location(li2, file$2, 9, 3, 260);
    			attr_dev(ul0, "id", "nav-mobile");
    			attr_dev(ul0, "class", "left");
    			add_location(ul0, file$2, 6, 2, 150);
    			attr_dev(ul1, "id", "nav-mobile");
    			attr_dev(ul1, "class", "right");
    			add_location(ul1, file$2, 11, 2, 312);
    			attr_dev(div, "class", "nav-wrapper");
    			add_location(div, file$2, 5, 1, 122);
    			attr_dev(nav, "class", "indigo darken-3");
    			add_location(nav, file$2, 4, 0, 91);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/components/misc/NotLoggedIn.svelte";
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(29:26)   <p>...</p> {:then loggedIn}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*isLoggedInPromise*/ ctx[1], info);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("isLoggedInPromise" in $$props) $$invalidate(1, isLoggedInPromise = $$props.isLoggedInPromise);
    	};
    	...
    	return [page$1, isLoggedInPromise];
    }
