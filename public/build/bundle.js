...
var app = (function () {
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("category = ");
    			t3 = text(/*category*/ ctx[1]);
    			add_location(p0, file$2, 77, 1, 1819);
    			add_location(p1, file$2, 78, 1, 1836);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
			...
			: "+" + /*total*/ ctx[5]}`;
    			...
    			attr_dev(h3, "class", "entries-header");
    			add_location(h3, file$2, 52, 1, 1242);
    			add_location(th0, file$2, 55, 3, 1304);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file$2, 56, 3, 1328);
    			attr_dev(tr0, "class", "svelte-3mphah");
    			add_location(tr0, file$2, 54, 2, 1296);
    			add_location(td0, file$2, 71, 3, 1660);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$2, 72, 3, 1679);
    			attr_dev(tr1, "class", "svelte-3mphah");
    			add_location(tr1, file$2, 70, 2, 1652);
    			attr_dev(table, "class", "svelte-3mphah");
    			add_location(table, file$2, 53, 1, 1286);
    			add_location(button, file$2, 75, 1, 1757);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(52:0) {#if entries !== undefined}",
    		ctx
    	});
    ...
    // (59:2) {#each sortedEntries as entry (entry.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(tr, "class", "svelte-3mphah");
    			add_location(tr, file$2, 59, 3, 1413);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:2) {#each sortedEntries as entry (entry.id)}",
    		ctx
    	});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const func = (entry, value) => entryChanged(entry, value);
    	const func_1 = (entry, value) => entryChanged(entry, value);
