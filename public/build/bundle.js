...
var app = (function () {
    ...
    const URL$1 = `${loc.protocol}//${loc.hostname}:8080/api`;
    ...
    var entry = { getAllEntries, getSpecificEntries, newEntry, getDefaultEntries };

    /* src/components/read/Category.svelte generated by Svelte v3.32.1 */

    const file = "src/components/read/Category.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 47, 1, 1167);
    			add_location(p1, file, 48, 1, 1184);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	let t9_value = (/*total*/ ctx[2] < 0
    	? /*total*/ ctx[2]
    	: "+" + /*total*/ ctx[2]) + "";

    	let t9;
    	let each_value = /*sortedEntries*/ ctx[3];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*entry*/ ctx[6].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file, 29, 1, 784);
    			add_location(th0, file, 32, 3, 846);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file, 33, 3, 870);
    			attr_dev(tr0, "class", "svelte-3mphah");
    			add_location(tr0, file, 31, 2, 838);
    			add_location(td0, file, 42, 3, 1064);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file, 43, 3, 1083);
    			attr_dev(tr1, "class", "svelte-3mphah");
    			add_location(tr1, file, 41, 2, 1056);
    			attr_dev(table, "class", "svelte-3mphah");
    			add_location(table, file, 30, 1, 828);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*sortedEntries*/ 8) {
    				each_value = /*sortedEntries*/ ctx[3];
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    			...
    			if (dirty & /*total*/ 4 && t9_value !== (t9_value = (/*total*/ ctx[2] < 0
    			? /*total*/ ctx[2]
    			: "+" + /*total*/ ctx[2]) + "")) set_data_dev(t9, t9_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:0) {#if entries !== undefined}",
    		ctx
    	});
    ...
    // (36:2) {#each sortedEntries as entry (entry.id)}
    function create_each_block(key_1, ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*entry*/ ctx[6].description + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*entry*/ ctx[6].amount + "";
    	let t2;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			td1 = element("td");
    			t2 = text(t2_value);
    			add_location(td0, file, 37, 4, 964);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file, 38, 4, 997);
    			attr_dev(tr, "class", "svelte-3mphah");
    			add_location(tr, file, 36, 3, 955);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:2) {#each sortedEntries as entry (entry.id)}",
    		ctx
    	});
    ...
    */
    	...
    	entries.forEach(entry => {
    		$$invalidate(2, total += entry.amount);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("negative" in $$props) negative = $$props.negative;
    		if ("positive" in $$props) positive = $$props.positive;
    		if ("sortedEntries" in $$props) $$invalidate(3, sortedEntries = $$props.sortedEntries);
    	};
    	...
    	return [entries, category, total, sortedEntries];
    }
    ...
    class Category extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*entries*/ ctx[0] === undefined && !("entries" in props)) {
    			console.warn("<Category> was created without expected prop 'entries'");
    		}
    ...
    /* src/components/read/Budget.svelte generated by Svelte v3.32.1 */
    const file$1 = "src/components/read/Budget.svelte";
    ...
    // (17:0) {#each data.categories as category}
    function create_each_block$1(ctx) {
    	...
    	category = new Category({
    			props: {
    				entries: /*seperated*/ ctx[1][/*category*/ ctx[3]],
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 17, 1, 556);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(category, div, null);
    			append_dev(div, t);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const category_changes = {};
    			if (dirty & /*seperated, data*/ 3) category_changes.entries = /*seperated*/ ctx[1][/*category*/ ctx[3]];
    			if (dirty & /*data*/ 1) category_changes.category = /*category*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:0) {#each data.categories as category}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Category, data, gemensamma, seperated });
    ...
    const file$2 = "src/components/read/ViewBudget.svelte";

    // (1:0) <script lang="ts">import entry from '../../controllers/entry'; import Budget from './Budget.svelte'; let dateString = new Date().toISOString().slice(0, 10); let data; $: {     data = entry.getSpecificEntries({ date: new Date(dateString) }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script lang=\\\"ts\\\">import entry from '../../controllers/entry'; import Budget from './Budget.svelte'; let dateString = new Date().toISOString().slice(0, 10); let data; $: {     data = entry.getSpecificEntries({ date: new Date(dateString) }",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 14, 14, 374);
    			add_location(h2, file$2, 14, 3, 363);
    			attr_dev(div, "class", "budget");
    			add_location(div, file$2, 13, 2, 339);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*data*/ 2) budget_changes.data = /*data*/ ctx[1];
    ...
    // (11:14)    <p>Hämtar budgetar</p>  {:then data}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 11, 2, 300);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(11:14)    <p>Hämtar budgetar</p>  {:then data}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 9, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ entry, Budget, dateString, data });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dateString*/ 1) {
    			{
    				$$invalidate(1, data = entry.getSpecificEntries({ date: new Date(dateString) }));
    			}
    		}
    	};

    	return [dateString, data, input_input_handler];
    }
    ...
    // (81:1) {#each entries as entry, index}
    function create_each_block$2(ctx) {
    	...
    	function input0_input_handler() {
    		/*input0_input_handler*/ ctx[4].call(input0, /*each_value*/ ctx[11], /*index*/ ctx[12]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[5].call(input1, /*each_value*/ ctx[11], /*index*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$3, 82, 3, 2187);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Belopp");
    			attr_dev(input1, "class", "amount svelte-1n6yju0");
    			add_location(input1, file$3, 88, 3, 2308);
    			attr_dev(div, "class", "entry-container svelte-1n6yju0");
    			add_location(div, file$3, 81, 2, 2154);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, input0);
    			set_input_value(input0, /*entry*/ ctx[10].description);
    			append_dev(div, t);
    			append_dev(div, input1);
    			set_input_value(input1, /*entry*/ ctx[10].amount);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*entries*/ 1 && input0.value !== /*entry*/ ctx[10].description) {
    				set_input_value(input0, /*entry*/ ctx[10].description);
    			}

    			if (dirty & /*entries*/ 1 && to_number(input1.value) !== /*entry*/ ctx[10].amount) {
    				set_input_value(input1, /*entry*/ ctx[10].amount);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(81:1) {#each entries as entry, index}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			input1 = element("input");
    			add_location(h4, file$3, 78, 0, 2049);
    			input0.disabled = true;
    			attr_dev(input0, "type", "text");
    			input0.value = "Totalt";
    			attr_dev(input0, "class", "description svelte-1n6yju0");
    			add_location(input0, file$3, 92, 2, 2445);
    			input1.disabled = true;
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "amount svelte-1n6yju0");
    			add_location(input1, file$3, 93, 2, 2513);
    			attr_dev(div, "class", "entry-container svelte-1n6yju0");
    			add_location(div, file$3, 91, 1, 2413);
    			add_location(form, file$3, 79, 0, 2069);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const update = () => {
    		...
    		entries.forEach(entry => {
    			if (isEmptyString(entry.description) && isEmptyString(entry.amount)) emptyEntries.push(entry); else $$invalidate(2, total += parseInt(entry.amount));
    		});
    		...
    		$$invalidate(0, entries = entries.filter(entry => !emptyEntries.includes(entry)));
    	...
    	function input1_input_handler(each_value, index) {
    		each_value[index].amount = to_number(this.value);
    		$$invalidate(0, entries);
    	}
    ...
    class Toast extends SvelteComponent$1 {
    	constructor(options) {
    		...
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal$1, { msg: 0, type: 1, position: 3 });
    	}
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*data*/ ctx[1].categories;
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "budget-container svelte-1q5qesb");
    			add_location(div0, file$4, 50, 2, 1388);
    			attr_dev(button, "class", "btn waves-effect waves-light indigo");
    			add_location(button, file$4, 59, 3, 1603);
    			attr_dev(div1, "class", "center");
    			add_location(div1, file$4, 58, 2, 1579);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*seperated, data*/ 3) {
    				each_value = /*data*/ ctx[1].categories;
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 48, 2, 1343);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (52:3) {#each data.categories as category}
    function create_each_block$3(ctx) {
    	...
    	newcategory = new NewCategory({
    			props: {
    				entries: /*seperated*/ ctx[0][/*category*/ ctx[4]],
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "budget svelte-1q5qesb");
    			add_location(div, file$4, 52, 4, 1462);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*seperated, data*/ 3) newcategory_changes.entries = /*seperated*/ ctx[0][/*category*/ ctx[4]];
    			if (dirty & /*data*/ 2) newcategory_changes.category = /*category*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(52:3) {#each data.categories as category}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[1] === undefined) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1q5qesb");
    			add_location(div, file$4, 46, 0, 1285);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	entry.getDefaultEntries().then(result => {
    		...
    		result.categories.forEach(category => {
    			$$invalidate(0, seperated[category] = result.result.filter(entry => entry.Category.name === category), seperated);
    		});

    		$$invalidate(1, data = result);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("seperated" in $$props) $$invalidate(0, seperated = $$props.seperated);
    		if ("data" in $$props) $$invalidate(1, data = $$props.data);
    	};
    ...
    const file$5 = "src/components/Navigator.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$5, 3, 7, 100);
    			add_location(li0, file$5, 3, 3, 96);
    			attr_dev(a1, "href", "/new");
    			attr_dev(a1, "class", "svelte-1u6n4gp");
    			add_location(a1, file$5, 4, 7, 132);
    			add_location(li1, file$5, 4, 3, 128);
    			attr_dev(ul, "id", "nav-mobile");
    			attr_dev(ul, "class", "left");
    			add_location(ul, file$5, 2, 2, 59);
    			attr_dev(div, "class", "nav-wrapper");
    			add_location(div, file$5, 1, 1, 31);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$6, 18, 0, 439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
