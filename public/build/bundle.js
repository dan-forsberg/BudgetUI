    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("category = ");
    			t3 = text(/*category*/ ctx[1]);
    			add_location(p0, file$2, 73, 1, 1716);
    			add_location(p1, file$2, 74, 1, 1733);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
			...
			: "+" + /*total*/ ctx[3]}`;
    			...
    			attr_dev(h3, "class", "entries-header");
    			add_location(h3, file$2, 50, 1, 1134);
    			add_location(th0, file$2, 53, 3, 1196);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file$2, 54, 3, 1220);
    			attr_dev(tr0, "class", "svelte-13a5tvb");
    			add_location(tr0, file$2, 52, 2, 1188);
    			add_location(td0, file$2, 67, 3, 1557);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$2, 68, 3, 1576);
    			attr_dev(tr1, "class", "svelte-13a5tvb");
    			add_location(tr1, file$2, 66, 2, 1549);
    			attr_dev(table, "class", "svelte-13a5tvb");
    			add_location(table, file$2, 51, 1, 1178);
    			add_location(button, file$2, 71, 1, 1654);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(tr, "class", "svelte-13a5tvb");
    			add_location(tr, file$2, 57, 3, 1305);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 59, 2, 1525);
    			add_location(p, file$6, 69, 4, 1757);
    			attr_dev(input, "class", "input-date svelte-mz7exr");
    			attr_dev(input, "type", "date");
    			add_location(input, file$6, 70, 4, 1798);
    			add_location(label, file$6, 68, 3, 1745);
    			add_location(br, file$6, 73, 3, 1899);
    			attr_dev(button, "class", "btn waves-effect waves-light indigo");
    			add_location(button, file$6, 74, 3, 1909);
    			attr_dev(div1, "class", "center");
    			add_location(div1, file$6, 67, 2, 1721);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$6, 57, 2, 1480);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 61, 4, 1599);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 55, 0, 1422);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
