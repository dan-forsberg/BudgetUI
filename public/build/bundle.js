...
var app = (function () {
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("category = ");
    			t3 = text(/*category*/ ctx[1]);
    			add_location(p0, file$2, 78, 1, 2515);
    			add_location(p1, file$2, 79, 1, 2532);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*sortedEntries*/ ctx[4];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*entry*/ ctx[12].id;
    	...
    	const block = {
			...
			: "+" + /*total*/ ctx[5]}`;
    			...
    			attr_dev(h3, "class", "entries-header");
    			add_location(h3, file$2, 53, 1, 1925);
    			add_location(th0, file$2, 56, 3, 1987);
    			attr_dev(th1, "class", "right");
    			add_location(th1, file$2, 57, 3, 2011);
    			attr_dev(tr0, "class", "svelte-3mphah");
    			add_location(tr0, file$2, 55, 2, 1979);
    			add_location(td0, file$2, 72, 3, 2356);
    			attr_dev(td1, "class", "right");
    			add_location(td1, file$2, 73, 3, 2375);
    			attr_dev(tr1, "class", "svelte-3mphah");
    			add_location(tr1, file$2, 71, 2, 2348);
    			attr_dev(table, "class", "svelte-3mphah");
    			add_location(table, file$2, 54, 1, 1969);
    			add_location(button, file$2, 76, 1, 2453);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*sortedEntries, entryChanged*/ 20) {
    				each_value = /*sortedEntries*/ ctx[4];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(53:0) {#if entries !== undefined}",
    		ctx
    	});
    ...
    // (60:2) {#each sortedEntries as entry (entry.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	function func(...args) {
    		return /*func*/ ctx[6](/*entry*/ ctx[12], ...args);
    	}

    	inplaceedit0 = new InPlaceEdit({
    			props: {
    				value: /*entry*/ ctx[12].description,
    				onSubmit: func
    			},
    			$$inline: true
    		});
    	...
    	function func_1(...args) {
    		return /*func_1*/ ctx[7](/*entry*/ ctx[12], ...args);
    	}

    	inplaceedit1 = new InPlaceEdit({
    			props: {
    				value: /*entry*/ ctx[12].amount,
    				onSubmit: func_1
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(tr, "class", "svelte-3mphah");
    			add_location(tr, file$2, 60, 3, 2096);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(60:2) {#each sortedEntries as entry (entry.id)}",
    		ctx
    	});
    ...
    const file$3 = "src/components/read/Budget.svelte";
    ...
    // (25:0) {#each data.categories as category}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 25, 1, 920);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:0) {#each data.categories as category}",
    		ctx
    	});
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let currPage = page.Context.pathname;

    	let component = currPage === "/edit" ? EditCategory : Category;
    	console.log("currpage: ");
    	console.dir(page.Context.canonicalPath);
    	const writable_props = ["data"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Budget> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currPage" in $$props) currPage = $$props.currPage;
    	...
    	return [data, seperated, component];
    }
    ...
    class Budget extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*data*/ ctx[0] === undefined && !("data" in props)) {
    			console_1.warn("<Budget> was created without expected prop 'data'");
    		}
    	}
    ...
    const file$4 = "src/components/read/ViewBudget.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 14, 14, 374);
    			add_location(h2, file$4, 14, 3, 363);
    			attr_dev(div, "class", "budget");
    			add_location(div, file$4, 13, 2, 339);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 11, 2, 300);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 9, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			input1 = element("input");
    			add_location(h4, file$5, 78, 0, 2049);
    			input0.disabled = true;
    			attr_dev(input0, "type", "text");
    			input0.value = "Totalt";
    			attr_dev(input0, "class", "description svelte-1n6yju0");
    			add_location(input0, file$5, 92, 2, 2445);
    			input1.disabled = true;
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "amount svelte-1n6yju0");
    			add_location(input1, file$5, 93, 2, 2513);
    			attr_dev(div, "class", "entry-container svelte-1n6yju0");
    			add_location(div, file$5, 91, 1, 2413);
    			add_location(form, file$5, 79, 0, 2069);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class NewCategory extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { entries: 0, category: 1 });
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 50, 2, 1388);
    			attr_dev(button, "class", "btn waves-effect waves-light indigo");
    			add_location(button, file$6, 59, 3, 1603);
    			attr_dev(div1, "class", "center");
    			add_location(div1, file$6, 58, 2, 1579);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$6, 48, 2, 1343);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 52, 4, 1462);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 46, 0, 1285);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$8, 21, 0, 490);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
